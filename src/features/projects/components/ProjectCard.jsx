function renderActionButtons(project, isGrid) {
...
export default function ProjectCard({ project, index, variant, clampDescription = false }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full">
        ...
        {renderActionButtons(project, false)}
      </div>
    </div>
  );
}
